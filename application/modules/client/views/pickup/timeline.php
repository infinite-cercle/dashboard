      ...
      <div>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-style1 mg-b-10">
            ...
            <li class="breadcrumb-item active" aria-current="page">Your Pickup Timeline</li>
          </ol>
        </nav>
        <h4 class="mg-b-0 tx-spacing--1">Track your waste pickup status</h4>
      </div>
              ...
              <?php foreach ($timeline['today'] as $key => $today) { ?>
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <p>
                      Added by&nbsp;<span class="badge badge-pill badge-primary"><?php echo $today['firstname'].' '.$today['lastname']; ?></span>&nbsp;<?php echo $today['designation']; ?> | <?php echo $today['email']; ?></p>
              ...
              <?php foreach ($timeline['yesterday'] as $key => $yesterday) { ?>
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <p>
                      Added by&nbsp;<span class="badge badge-pill badge-primary"><?php echo $yesterday['firstname'].' '.$yesterday['lastname']; ?></span>&nbsp;<?php echo $yesterday['designation']; ?> | <?php echo $yesterday['email']; ?></p>
              ...
              <?php $prevdate = $thisdate; } ?>
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <p>
                      Added by&nbsp;<span class="badge badge-pill badge-primary"><?php echo $other['firstname'].' '.$other['lastname']; ?></span>&nbsp;<?php echo $other['designation']; ?> | <?php echo $other['email']; ?></p>
